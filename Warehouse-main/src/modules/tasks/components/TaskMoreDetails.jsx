...
function MyTaskWarehouse({id, data, getAttr}) {
            ...
            <div className="planes">
                ...
                { !id ? '' : <Stage width={10000} height={10000} className='planes-area' style={zoomStyle}>
                    <Layer>
                        ...
                        { shelves.length ? shelves.map( (item, index) => {
                            return (
                                <>
                                    <Rect
                                        key={index}
                                    ...
                                    <Text
                                        ...
                                        fontSize={item.shelf_level > 1 ? 13 : 20}
                                        fill="white"
                                        width={item.width}
                                        height={item.height}
                                        align="center"
...
export default MyTaskWarehouse
